...
function obtenerLargoDelArray(array) {
   ...
   // Tu código:
   var longitudArreglo = array.length
...
function incrementarPorUno(array) {
   ...
   // Tu código:
  var arregloIncremento = array.map((num)=> {
   return num +1
  })
...
function todosIguales(array) {
   ...
   // Tu código:
   var arregloIgual = array.every(item => {
      return item === array[0]
   });
   return arregloIgual;
}
...
function mesesDelAño(array) {
   ...
   array.forEach((mes) => {
      if(mes === "Enero" || mes === "Marzo" || mes === "Noviembre") {
         mesesArreglo.push(mes);
      }
   });
   
   if(mesesArreglo.length < 3) {
...
function mayorACien(array) {
   ...
   // Tu código:
   let newArreglo = array.filter(num => num > 100)
   return newArreglo;
}
